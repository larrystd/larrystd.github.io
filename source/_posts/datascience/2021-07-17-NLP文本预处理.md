...
file = gutenberg.sents('edgeworth-parents.txt')

basedir = os.path.dirname(__file__)
with open(basedir+"/gutenberg/chesterton-ball.txt", "rb") as f:
    data = str(f.read())
...
for i in range(NUM):
    ...
    sent = data[i].lower()
    words = word_tokenize(sent)  # 分词
    without_stopwords = [w for w in words if not w in stopwords.words('english')] #去除停用词
