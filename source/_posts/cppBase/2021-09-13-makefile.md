...
project项目信息; add_subdirectory 添加子目录; 指定生成目标(相当于-o)add_executable; 添加链接库target_link_libraries; 生成链接库add_library
...
注意, target_link_libraries里库文件的顺序符合gcc链接顺序的规则，即被依赖的库放在依赖它的库的后面
