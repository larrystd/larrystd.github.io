...
public:
    ...
    SharedptrImpl(T* ptr) : ptr_(ptr), refcount_(new int(1)), _isalive(true) 
    {}
    ...
    : ptr_(sp.ptr_), refcount_(sp.refcount_), mtx_(sp.mtx_),isalive_(sp.isalive_)
    {
